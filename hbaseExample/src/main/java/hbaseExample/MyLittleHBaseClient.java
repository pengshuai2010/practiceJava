...
/**
 * This example is adapted from https://hbase.apache.org/apidocs/org/apache/hadoop/hbase/client/package-summary.html
 * 
 * Created by speng on 4/26/16.
 */
...
public class MyLittleHBaseClient {
  public static void main(String[] args) throws IOException {
    ...
    try {
        ...
        HTableDescriptor tableDescriptor = new HTableDescriptor(TableName.valueOf("myLittleHBaseTable"));

        // Adding column families to table descriptor
        tableDescriptor.addFamily(new HColumnDescriptor("myLittleFamily"));
